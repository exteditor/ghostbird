...
[<img src="_media/blue.svg" width="48" height="48" border="1" align="right" alt="logo" title="Grey-headed bushshrike (Malaconotus blanchoti) is sometimes called 'ghostbird'">][bird]
...
3. Press the gray Ghostbird button <img src="_media/gray.svg" width="24" height="24" border="1"> in the Thunderbird mail compose window. (The default shortcut is `Ctrl-E`)
   * If the connection is successful, the button will turn blue <img src="_media/blue.svg" width="24" height="24" border="1">.
   * If the connection fails, the button will turn red <img src="_media/red.svg" width="24" height="24" border="1">. Make sure that the GhostText server is listening. See [Troubleshooting page of original GhostText](https://ghosttext.fregante.com/troubleshooting/#unable-to-connect).
...
* See [design.md](documents/doc/design.md) for details.
...
* Feel free to open issues and submit pull requests. See [CONTRIBUTING.md](documents/CONTRIBUTING.md) to get started.
...
* Automating test with the real Thunderbird (See [Testing](documents/doc/testing.md))
...
* See [faq.md](documents/doc/faq.md).
...
* See [CONTRIBUTING.md](documents/CONTRIBUTING.md) for details on the development workflow.
...
* See [doc/faq.md](documents/doc/faq.md).
...
Ghostbird is licensed under [MPL-2.0](_media/LICENSE) by @snipsnipsnip and contributors. See also [NOTICE](documents/ext/NOTICE.md).
...
[sublimetext-svg]: _media/sublimetext.svg
[vscode-svg]: _media/vscode.svg
[emacs-svg]: _media/emacs.svg
[vim-svg]: _media/vim.svg
[nvim-svg]: _media/nvim.svg
